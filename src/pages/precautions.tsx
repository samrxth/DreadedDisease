          ...
          primarySlot={
            <div className="lg:pr-20 xl:pr-32 lg:pl-10">
              ...
              <p className="pt-2 leading-relaxed text-gray-700 text-md md:text-xl">
                When there are large gatherings, the chances of the virus spreading quickly and to many people are
                highly likely. Practicing social distancing helps to reduce opportunities for disease transmission.
              </p>
            </div>
          }
          ...
          primarySlot={
            <div className="py-40 lg:pr-20 xl:pr-32">
              ...
              <p className="leading-relaxed text-gray-400 text-md md:text-xl">
                ...
                that masks reduce the spray of droplets when worn over the nose and mouth. You should wear a mask, even
            ...
            <div className="py-24 lg:pr-20 xl:pr-32">
              ...
              <p className="leading-relaxed text-gray-400 text-md md:text-xl">
                <ul className="list-disc list-outside">
                  <li className="pt-4">
                    <b>If you are wearing a mask: </b>You can cough or sneeze into your mask. Put on a new, clean mask
