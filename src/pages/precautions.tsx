  ...
  return (
    <Layout>
        ...
        primarySlot={
          <div className="lg:pr-20 xl:pr-32">
            ...
            <p className="leading-relaxed text-gray-400 text-md md:text-xl">
              Covid-19 vaccines produce antibodies to the coronavirus. These antibodies help your immune system fight
              the virus if you happen to be exposed, so it reduces your chance of getting the disease.
            </p>
          </div>
        }
      ...
      <SplitSection
        ...
        primarySlot={
          <div className="lg:pr-20 xl:pr-32 lg:pl-10">
            <h3 className="text-3xl font-semibold leading-tight md:text-4xl">Social Distancing</h3>
            <p className="pt-2 leading-relaxed text-gray-700 text-md md:text-xl">
              When there are large gatherings, the chances of the virus spreading quickly and to many people are highly
              likely. Practicing social distancing helps to reduce opportunities for disease transmission.
            </p>
          </div>
        }
      ...
      <SplitSection
        ...
        primarySlot={
          <div className="py-40 lg:pr-20 xl:pr-32">
            ...
            <p className="leading-relaxed text-gray-400 text-md md:text-xl">
              Masks are a simple barrier to help prevent your respiratory droplets from reaching others. Studies show
              that masks reduce the spray of droplets when worn over the nose and mouth. You should wear a mask, even if
      ...
      <SplitSection
        ...
        primarySlot={
          <div className="lg:pr-20 xl:pr-32">
            <h3 className="text-3xl font-semibold leading-tight md:text-4xl">Wash your hands often</h3>
          ...
          <div className="py-24 lg:pr-20 xl:pr-32">
            ...
            <p className="leading-relaxed text-gray-400 text-md md:text-xl">
              <ul className="list-disc list-outside">
                <li className="pt-4">
                  <b>If you are wearing a mask: </b>You can cough or sneeze into your mask. Put on a new, clean mask as
                ...
                <li className="pt-8">
                  ...
                  <ul className="list-disc list-inside">
                    <li className="pt-4">
                      Always cover your mouth and nose with a tissue when you cough or sneeze, or use the inside of your
