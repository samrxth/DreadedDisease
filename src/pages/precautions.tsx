    ...
    <Layout>
      <div className="h-screen bg-gray-900">
        <div className="pt-20 mx-auto text-center">
          <h2 className="text-6xl font-semibold text-primary-lighter">
            Precautions
          </h2>
        </div>
        <SplitSection
          ...
          primarySlot={
            <div className="lg:pr-20 xl:pr-32">
              ...
              <p className="leading-relaxed text-gray-400 text-md md:text-xl">
                Covid-19 vaccines produce antibodies to the coronavirus. These
                antibodies help your immune system fight the virus if you happen
                to be exposed, so it reduces your chance of getting the disease.
              </p>
            </div>
          }
          ...
          primarySlot={
            <div className="lg:pr-20 xl:pr-32 lg:pl-10">
              ...
              <p className="pt-2 leading-relaxed text-gray-700 text-md md:text-xl">
                When there are large gatherings, the chances of the virus
                spreading quickly and to many people are highly likely.
                Practicing social distancing helps to reduce opportunities for
          ...
          primarySlot={
            <div className="py-40 lg:pr-20 xl:pr-32">
              ...
              <p className="leading-relaxed text-gray-400 text-md md:text-xl">
                ...
                droplets from reaching others. Studies show that masks reduce
                the spray of droplets when worn over the nose and mouth. You
                should wear a mask, even if you do not feel sick.
              </p>
            </div>
          }
            ...
            <div className="py-24 lg:pr-20 xl:pr-32">
              ...
              <p className="leading-relaxed text-gray-400 text-md md:text-xl">
                <ul className="list-disc list-outside">
                  <li className="pt-4">
                    <b>If you are wearing a mask: </b>You can cough or sneeze
                    into your mask. Put on a new, clean mask as soon as possible
                    and wash your hands.
                  </li>
                  <li className="pt-8">
        ...
        <p className="py-10 text-center text-gray-500">
          Made by{' '}
          <a href="https://github.com/samrath2007/">Samrath Singh Chadha</a>
        </p>
      </div>
    </Layout>
  );
